...
public class ComputingTaxes {
    ...
    public static double headOfHouseholdTaxAmount(double income){
        ...
        if(income <= 11950){
            ...
            tax = (11950 * 0.10) + ((44500-11950) * 0.15) + ((income -44500)  * 0.25);
        }else if(income >117451 && income <= 190200) {
            tax = (11950 * 0.10) + ((44500-11950) * 0.15) + ((117450 -44500)  * 0.25) + ((income- 117450)* 0.28);
        }else if(income >190201 && income <= 372950) {
            tax = (11950 * 0.10) + ((44500-11950) * 0.15) + ((117450 -44500)  * 0.25) + ((190200- 117450)* 0.28) + ((income- 190200) * 0.33);
        }else if(income > 372951 ) {
            tax = (11950 * 0.10) + ((44500-11950) * 0.15) + ((117450 -44500)  * 0.25) + ((190200- 117450)* 0.28) + ((372950- 190200) * 0.33) + ((income - 372950) * 0.35);
        }
